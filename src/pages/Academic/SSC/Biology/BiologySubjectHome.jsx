...
import chaptersData from '../../../../components/Academic/SSC/Biology/Biology_data/chapters.json';
import videosData from '../../../../components/Academic/SSC/Biology/Biology_data/videos.json';
import notesData from '../../../../components/Academic/SSC/Biology/Biology_data/notes.json';
import SSCChapterCard from '../../../../components/Academic/SSC/Shared/SSCChapterCard';

const cqsLoaders = import.meta.glob(
  '../../../../components/Academic/SSC/Biology/Biology_data/chapter_*_Json/*_CQs.json'
);
const mcqsLoaders = import.meta.glob(
  '../../../../components/Academic/SSC/Biology/Biology_data/chapter_*_Json/*_MCQs.json'
);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-12 lg:py-16">
      <nav className="flex items-center gap-1 sm:gap-2 text-xs sm:text-sm text-slate-500 mb-6 sm:mb-8 font-medium flex-wrap">
        ...
        <ChevronRight className="w-3 h-3 sm:w-4 sm:h-4 shrink-0" />
        <span className="text-indigo-400 whitespace-nowrap">জীববিজ্ঞান</span>
      </nav>
      ...
      <div className="mb-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 lg:gap-6">
          {chaptersData.chapters.map((baseChapter) => {
            ...
            return <SSCChapterCard key={chapterId} chapter={fullChapter} basePath="/academic/ssc/biology" />;
          })}
        </div>
      </div>
    </div>
...
export default BiologySubjectHome;
