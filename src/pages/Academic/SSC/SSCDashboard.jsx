      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-10">
        ...
        <div className="relative">
          ...
          <div className="relative z-10">
            <h1 className="text-3xl sm:text-4xl font-black bg-clip-text text-transparent bg-gradient-to-r from-white via-emerald-200 to-emerald-400 drop-shadow-sm mb-2">
              এসএসসি (SSC)
            </h1>
            <p className="text-slate-400 text-sm sm:text-base font-medium">নবম-দশম শ্রেণির সকল বিষয় ও স্টাডি ম্যাটেরিয়াল</p>
          </div>
          
          {/* Global Search Bar (Mobile focused) */}
          <div className="mt-6 relative z-10">
            <div className="flex items-center bg-slate-800/40 border border-slate-700/50 rounded-2xl p-2 shadow-inner backdrop-blur-md focus-within:border-emerald-500/50 focus-within:ring-1 focus-within:ring-emerald-500/50 transition-all">
