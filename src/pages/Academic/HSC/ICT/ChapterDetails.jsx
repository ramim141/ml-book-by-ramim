...
const chapterLoaders = import.meta.glob(
  '../../../../components/Academic/HSC/ICT/ICT_data/chapter_*_Json/chapter_*_CQs.json'
);
...
// Expose for ChapterCard hover prefetch
...
const ChapterDetails = () => {
  ...
  useEffect(() => {
    const first = videosData[chapterId]?.[0];
