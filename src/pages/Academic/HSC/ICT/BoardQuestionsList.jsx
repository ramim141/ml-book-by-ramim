    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 mb-10">
        <div>
          <div className="flex items-center gap-3 mb-2">
            <Link to="/academic/hsc/ict" className="p-2 hover:bg-slate-800 rounded-lg text-slate-400 hover:text-white transition-colors">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredBoards.map((board) => (
          <div key={board.id} className="bg-slate-800/30 border border-slate-700/50 rounded-2xl p-6 hover:border-indigo-500/50 hover:bg-slate-800/50 transition-all group relative overflow-hidden flex flex-col h-full">
      ...
      {filteredBoards.length === 0 && (
        <div className="bg-slate-800/30 border border-slate-700/50 rounded-2xl p-16 text-center">
          ...
          <h3 className="text-xl font-bold text-slate-300 mb-2">কোনো প্রশ্নপত্র পাওয়া যায়নি</h3>
