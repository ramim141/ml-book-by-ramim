...
const mcqsModules = import.meta.glob('../../../../components/Academic/HSC/Chemistry/Chemistry_data/chapter_*_Json/*_MCQs.json', { eager: true });
...
const ChemistrySubjectHome = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
      ...
      <Link to="/academic/hsc/chemistry/board-questions" className="block mb-12">
