...
import ChapterCard from '../../../../components/Academic/HSC/Chemistry/ChapterCard';

// Lazy loaders for CQs/MCQs JSONs — fetched on-demand to keep this route light.
...
const mcqsLoaders = import.meta.glob(
  '../../../../components/Academic/HSC/Chemistry/Chemistry_data/chapter_*_Json/*_MCQs.json'
);
...
const ChemistrySubjectHome = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-12 lg:py-16">
      ...
      <Link to="/academic/hsc/chemistry/board-questions" className="block mb-8 sm:mb-10 lg:mb-12">
