...
export default function MedicalDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0f1c] pb-24 sm:pb-12 pt-4 sm:pt-8 font-bangla selection:bg-rose-500/30 text-slate-100">
      <div className="max-w-7xl mx-auto px-3.5 sm:px-6 lg:px-8 space-y-6 sm:space-y-10">
        ...
        <div>
          <Link
            ...
            className="inline-flex items-center gap-1.5 text-rose-400 hover:text-rose-300 text-xs sm:text-sm font-semibold transition mb-3 sm:mb-4 group"
          >
          ...
          <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-gradient-to-r from-rose-950/40 via-slate-900 to-indigo-950/40 border border-rose-500/20 p-4 sm:p-8 lg:p-10 shadow-2xl backdrop-blur-xl">
            <div className="absolute -right-10 -top-10 w-48 sm:w-72 h-48 sm:h-72 bg-rose-500/10 rounded-full blur-3xl pointer-events-none" />
            <div className="absolute right-1/3 -bottom-10 w-48 sm:w-64 h-48 sm:h-64 bg-indigo-500/10 rounded-full blur-3xl pointer-events-none" />

            <div className="relative z-10 max-w-3xl space-y-2.5 sm:space-y-4">
              <div className="inline-flex items-center gap-1.5 px-2.5 sm:px-3 py-1 rounded-full bg-rose-500/10 border border-rose-500/30 text-rose-400 text-[10.5px] sm:text-xs font-black tracking-wide">
              ...
              <div className="flex flex-wrap items-center gap-2 sm:gap-3 pt-1 sm:pt-2">
                ...
                <div className="flex items-center gap-1.5 px-2.5 sm:px-3.5 py-1 sm:py-1.5 rounded-xl bg-indigo-500/10 border border-indigo-500/30 text-[10.5px] sm:text-xs font-bold text-indigo-300">
        ...
        {/* Quick Actions (Responsive 5-column / 3-column / 2-column Grid) */}
        <section className="relative z-10">
          <div className="flex items-center justify-between mb-3 sm:mb-4">
            <h2 className="text-base sm:text-lg font-bold text-slate-200 flex items-center gap-2">
              ...
              <span>মেডিকেল কুইক অ্যাকশন</span>
            </h2>
          </div>
        ...
        <section className="space-y-3">
          <div className="flex items-center justify-between">
            <h2 className="text-base sm:text-xl font-bold text-white flex items-center gap-2">
              <Layers className="h-4 w-4 sm:h-5 sm:w-5 text-rose-400" />
              <span>বিষয়সমূহ ও নম্বর বণ্টন ({dynamicMedicalSubjects.length}টি)</span>
            </h2>

            <Link
              to="/academic/admission/medical/highlighted-lines"
              className="text-[11px] sm:text-xs font-bold text-rose-400 hover:text-rose-300 flex items-center gap-1 transition"
            >
            ...
            {dynamicMedicalSubjects.map((item) => {
              ...
              return (
                <Link
                  ...
                  className="rounded-2xl border p-3.5 sm:p-4 transition-all duration-300 text-left flex flex-col justify-between group shadow-lg bg-slate-900/70 border-slate-800/80 hover:border-rose-500/40 hover:bg-slate-800/60 hover:-translate-y-0.5"
                >
                  <div className="space-y-2.5 sm:space-y-3 w-full">
                    <div className="flex items-center justify-between">
                      <div className={`p-2 sm:p-2.5 rounded-xl bg-gradient-to-br ${item.color} text-white shadow-md group-hover:scale-105 transition-transform`}>
                        <Icon className="w-4 h-4 sm:w-5 sm:h-5" />
                      </div>
                      <span className="text-lg sm:text-xl font-black font-mono px-2 sm:px-2.5 py-0.5 rounded-lg border bg-slate-800/80 text-white border-slate-700 group-hover:border-rose-500/30 group-hover:text-rose-300 transition-colors">
                        {item.marks}
                      </span>
                    </div>
                    <div>
                  ...
                  <div className="pt-2.5 sm:pt-3 border-t border-slate-800/60 mt-2.5 sm:mt-3 flex items-center justify-between w-full text-xs">
                    <span className="text-slate-400 text-[11px] sm:text-xs">{item.chapters?.length || 0}টি অধ্যায়</span>
                    <span className="text-rose-400 font-bold text-[11px] sm:text-xs flex items-center gap-1 group-hover:translate-x-1 transition-transform">
        ...
        <section id="medical-content-section" className="space-y-5 sm:space-y-6 pt-1 sm:pt-2 scroll-mt-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div className="lg:col-span-2 space-y-4 sm:space-y-6">
              ...
              <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-gradient-to-br from-slate-900 via-slate-900/90 to-rose-950/30 border border-slate-800 p-4 sm:p-7 shadow-2xl space-y-3.5 sm:space-y-4">
                <div className="absolute right-0 top-0 w-48 sm:w-64 h-48 sm:h-64 bg-rose-500/10 rounded-full blur-3xl pointer-events-none" />

                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 relative z-10">
                  <div className="space-y-1">
                    <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-rose-500/15 text-rose-300 border border-rose-500/30 text-[10.5px] sm:text-[11px] font-black">
                  ...
                  <Link
                    ...
                    className="w-full sm:w-auto shrink-0 px-4 sm:px-5 py-2.5 sm:py-3 rounded-xl sm:rounded-2xl bg-gradient-to-r from-rose-600 to-pink-600 hover:from-rose-500 hover:to-pink-500 text-white font-bold text-xs shadow-lg shadow-rose-600/25 active:scale-95 transition flex items-center justify-center gap-2"
                  >
                ...
                <div className="pt-2.5 sm:pt-3 border-t border-slate-800/80 flex items-center gap-1.5 sm:gap-2 flex-wrap text-xs text-slate-400">
                  ...
                  <span className="px-2 py-0.5 rounded-md bg-slate-800 text-slate-300 border border-slate-700 text-[10px] sm:text-[11px]">বায়োলজি (৩০)</span>
                  <span className="px-2 py-0.5 rounded-md bg-slate-800 text-slate-300 border border-slate-700 text-[10px] sm:text-[11px]">রসায়ন (২৫)</span>
                  <span className="px-2 py-0.5 rounded-md bg-slate-800 text-slate-300 border border-slate-700 text-[10px] sm:text-[11px]">পদার্থ (২০)</span>
                  <span className="px-2 py-0.5 rounded-md bg-slate-800 text-slate-300 border border-slate-700 text-[10px] sm:text-[11px]">ইংরেজি (১৫)</span>
                  <span className="px-2 py-0.5 rounded-md bg-slate-800 text-slate-300 border border-slate-700 text-[10px] sm:text-[11px]">জিকে (১০)</span>
                </div>
              </div>
              ...
              <div className="rounded-2xl sm:rounded-3xl bg-slate-900/80 border border-slate-800 p-4 sm:p-6 space-y-3.5 sm:space-y-4 shadow-xl">
                <div className="flex items-center justify-between">
                  <h3 className="text-sm sm:text-base font-bold text-white flex items-center gap-2">
                    ...
                    <span>বিষয়ভিত্তিক নম্বর বণ্টন ও ওয়েটেজ</span>
                  </h3>
                ...
                {/* Subject Badges with percentages (Responsive 5-column / 3-column / 2-column) */}
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2 sm:gap-2.5 pt-1 sm:pt-2">
                  <div className="p-2 sm:p-2.5 rounded-xl bg-slate-800/60 border border-slate-700/60 flex items-center justify-between">
                    <span className="text-[11px] sm:text-xs font-bold text-slate-200">জীববিজ্ঞান</span>
                    <span className="text-xs font-black font-mono text-emerald-400">৩০</span>
                  </div>
                  <div className="p-2 sm:p-2.5 rounded-xl bg-slate-800/60 border border-slate-700/60 flex items-center justify-between">
                    <span className="text-[11px] sm:text-xs font-bold text-slate-200">রসায়ন</span>
                    <span className="text-xs font-black font-mono text-rose-400">২৫</span>
                  </div>
                  <div className="p-2 sm:p-2.5 rounded-xl bg-slate-800/60 border border-slate-700/60 flex items-center justify-between">
                    <span className="text-[11px] sm:text-xs font-bold text-slate-200">পদার্থবিজ্ঞান</span>
                    <span className="text-xs font-black font-mono text-blue-400">২০</span>
                  </div>
                  <div className="p-2 sm:p-2.5 rounded-xl bg-slate-800/60 border border-slate-700/60 flex items-center justify-between">
                    <span className="text-[11px] sm:text-xs font-bold text-slate-200">ইংরেজি</span>
                    <span className="text-xs font-black font-mono text-amber-400">১৫</span>
                  </div>
                  <div className="p-2 sm:p-2.5 rounded-xl bg-slate-800/60 border border-slate-700/60 flex items-center justify-between col-span-2 sm:col-span-1 lg:col-span-1">
                    <span className="text-[11px] sm:text-xs font-bold text-slate-200">সাধারণ জ্ঞান</span>
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="rounded-2xl sm:rounded-3xl bg-slate-900/80 border border-slate-800 p-4 sm:p-6 space-y-3.5 sm:space-y-4 shadow-xl">
                ...
                <ul className="space-y-2.5 sm:space-y-3 text-xs text-slate-300">
                  <li className="flex items-start gap-2.5 p-2 sm:p-2.5 rounded-xl bg-slate-800/50 border border-slate-700/50">
                    <span className="w-5 h-5 rounded-lg bg-rose-500/20 text-rose-300 font-bold flex items-center justify-center shrink-0 mt-0.5 text-xs">1</span>
                    <div>
                      <strong className="text-slate-100 block text-xs">বিগত ২৫ বছরের প্রশ্ন সলভ</strong>
                      <span className="text-slate-400 text-[10.5px]">MBBS ও BDS আসল প্রশ্ন প্র্যাকটিস</span>
                    </div>
                  </li>
                  <li className="flex items-start gap-2.5 p-2 sm:p-2.5 rounded-xl bg-slate-800/50 border border-slate-700/50">
                    <span className="w-5 h-5 rounded-lg bg-rose-500/20 text-rose-300 font-bold flex items-center justify-center shrink-0 mt-0.5 text-xs">2</span>
                    <div>
                      <strong className="text-slate-100 block text-xs">পাঠ্যবইয়ের দাগানো লাইন রিভিশন</strong>
                      <span className="text-slate-400 text-[10.5px]">আজমল, হাসান ও হাজারী স্যারের নোটস</span>
                    </div>
                  </li>
                  <li className="flex items-start gap-2.5 p-2 sm:p-2.5 rounded-xl bg-slate-800/50 border border-slate-700/50">
                    <span className="w-5 h-5 rounded-lg bg-rose-500/20 text-rose-300 font-bold flex items-center justify-center shrink-0 mt-0.5 text-xs">3</span>
                    <div>
                  ...
                  <li className="flex items-start gap-2.5 p-2 sm:p-2.5 rounded-xl bg-slate-800/50 border border-slate-700/50">
                    <span className="w-5 h-5 rounded-lg bg-rose-500/20 text-rose-300 font-bold flex items-center justify-center shrink-0 mt-0.5 text-xs">4</span>
                    <div>
                      <strong className="text-slate-100 block text-xs">মেডি ছন্দ ও ট্রিকস রিভিশন</strong>
                      <span className="text-slate-400 text-[10.5px]">কনফিউজিং টপিক দ্রুত মনে রাখার উপায়</span>
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-2xl sm:rounded-3xl bg-gradient-to-br from-rose-950/20 to-slate-900 border border-rose-500/25 p-4 sm:p-5 space-y-2.5 sm:space-y-3 shadow-lg">
