...
const AcademicFooter = () => {
  return (
    <footer className="bg-[#0b0f19] border-t border-indigo-500/10 py-8 sm:py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        <div className="flex items-center gap-2 mb-4">
          <BookOpen className="h-5 w-5 sm:h-6 sm:w-6 text-indigo-400" />
          <span className="text-base sm:text-xl font-semibold text-slate-200">একাডেমিক হাব</span>
        </div>
        ...
        <div className="mt-6 sm:mt-8 pt-6 sm:pt-8 border-t border-slate-800 w-full text-center">
